...
APIKEY: str = EnvApiKey.GroqApiKeyOne
ENDPOINT: str = EnvApiEndPoint.GroqApiEndPoint

async def NativeLlama3Model70B(SystemInstruction: str) -> str:
    """
    ...
    """
    logger.info("Native Llama3-70B-Model Triggered with the system instruction.")
...
#     start = time.time()
#     res =  asyncio.run(NativeLlama3Model70B(SystemInstruction="what is python"))
#     end = time.time()
