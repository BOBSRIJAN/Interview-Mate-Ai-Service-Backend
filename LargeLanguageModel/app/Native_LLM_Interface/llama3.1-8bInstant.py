...
APIKEY: str = EnvApiKey.GroqApiKeyThree
ENDPOINT: str = EnvApiEndPoint.GroqApiEndPoint

async def NativeLlama3Model8B(SystemInstruction: str) -> str:
    """
    ...
    """
    logger.info("Native Llama3-8B-Model Triggered with the system instruction.")
...
#     start = time.time()
#     res =  asyncio.run(NativeLlama3Model8B(SystemInstruction="what is python"))
#     end = time.time()
